document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            navAbout: "About",
            navContact: "Contact",
            heroTitle: "Digital Solutions: Ideas to Reality",
            heroSubtitle: "We create customized solutions to boost your projects and achieve your goals.",
            ...
            serviceCard4Desc: "We ensure everything functions optimally, securely, and scalably over time.",
            ...
            project1Title: "CoreOps (Operational Nucleus)",
            project1Desc: "A comprehensive platform with multiple internal industrial applications for analysis of polyvalence, data, claims, operational areas, and lead times.",
            projectGymMasterTitle: "GymMaster",
            projectGymMasterDesc: "A licensed desktop application with client and administration panels, offering detailed analysis of clients, attendance, revenue, and business metrics. Expandable with additional modules.",
            project2Title: "E-Commerce Project",
            project2Desc: "Custom e-commerce platform with product and cart management, and secure payments via Mercado Pago API.",
            project3Title: "Multi-screen Image Viewer",
            project3Desc: "Web application that allows viewing images in carousel mode on multiple screens through browsers.",
            projectMotorRepairTitle: "Electric Motor Repair Website",
            projectMotorRepairDesc: "Website for an industrial motor repair company, specialists with 24-hour emergency service.",
        ...
        es: {
            ...
            navAbout: "Nosotros",
            navContact: "Contacto",
            heroTitle: "Soluciones Digitales: Ideas a Realidad",
            heroSubtitle: "Creamos soluciones personalizadas para impulsar tus proyectos y alcanzar tus metas.",
            ...
            serviceCard4Desc: "Nos aseguramos que funcione todo de manera optima, segura, escalable en el tiempo.",
            ...
            project1Title: "Núcleo Operativo (CoreOps)",
            project1Desc: "Una plataforma integral con múltiples aplicaciones industriales para análisis de polivalencia, datos, reclamos, áreas operativas, y más.",
            projectGymMasterTitle: "GymMaster",
            projectGymMasterDesc: "Una aplicación de escritorio licenciada con paneles de cliente y administración, que ofrece análisis detallados de clientes, afluencia, ingresos y métricas de negocio. Ampliable con módulos adicionales.",
            project2Title: "Proyecto E-Commerce",
            ...
            project3Title: "Visor de Imágenes Multi-pantalla",
            project3Desc: "Aplicación Web que permite visualizar imágenes en modo carrusel en múltiples pantallas a través de navegadores.",
            projectMotorRepairTitle: "Web de Reparacion de Motores Eléctricos",
            projectMotorRepairDesc: "Página web para empresa de reparación de motores industriales, especialistas con servicio de auxilio 24hs.",
